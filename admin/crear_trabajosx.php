...
$insertar="INSERT INTO trabajos (id,autor,categoria,titulo,estado,gestion,bimestre,fecha_final) VALUES(NULL,'$autor','$categoria','$titulo','$estado','$gestion','$bimestre','$fecha2') ";
if ($resultado=$link->query($insertar)) {
echo "<script> alert (\"LOGIN:: Correcto: Autorizado para Crear Nueva Evaluación \"); </script>"; 
      echo "<script language=Javascript> location.href=\"trabajos_full.php?categoria=$categoria&titulo=$titulo\"; </script>"; 
      echo "Creación CORRECTA";      
//header("Location: eva1.php?categoria=$categoria&titulo=$titulo");
}else{
  echo "Error al crear la CATEGORÍA ";
  echo "<a href ='crear_trabajos.php'> REGRESAR </a>";
}
