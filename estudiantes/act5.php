...
<hr>
      ...
      <div class="container">
<form action="act5x.php" method="post" id="test">
...
<?php
$ran5=$_GET['ran5'];
$consulta="SELECT * FROM preguntas WHERE id_examen='$id_examen' AND numero='$ran5'";
if ($resultado=$link->query($consulta)) {
         while ($row=$resultado->fetch_assoc()) {
...
echo "<tr>";
echo "<td colspan='2'><strong>PREGUNTA # 5:</strong><font class='lead text-primary'> ".$preg."</font><br><br>";

echo "<input type='hidden' name='id_examen' value='".$id_examen."'>"; 
echo "<input type='hidden' name='ran5' value='".$ran5."'>";     
