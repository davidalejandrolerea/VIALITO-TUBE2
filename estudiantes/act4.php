...
<hr>
      ...
      <div class="container">
<form action="act4x.php" method="post" id="test">
...
<?php
$ran4=$_GET['ran4'];
$consulta="SELECT * FROM preguntas WHERE id_examen='$id_examen' AND numero='$ran4'";
if ($resultado=$link->query($consulta)) {
         while ($row=$resultado->fetch_assoc()) {
...
echo "<tr>";
echo "<td colspan='2'><strong>PREGUNTA # 4:</strong><font class='lead text-primary'> ".$preg."</font><br><br>";

echo "<input type='hidden' name='id_examen' value='".$id_examen."'>"; 
echo "<input type='hidden' name='ran4' value='".$ran4."'>";     
