...
<hr>
      ...
      <div class="container">
<form action="act7x.php" method="post"  id="test">
...
<?php
$ran7=$_GET['ran7'];
$consulta="SELECT * FROM preguntas WHERE id_examen='$id_examen' AND numero='$ran7'";
if ($resultado=$link->query($consulta)) {
         while ($row=$resultado->fetch_assoc()) {
...
echo "<tr>";
echo "<td colspan='2'><strong>PREGUNTA # 7:</strong><font class='lead text-primary'> ".$preg."</font><br><br>";

echo "<input type='hidden' name='id_examen' value='".$id_examen."'>"; 
echo "<input type='hidden' name='ran7' value='".$ran7."'>";     
