...
<hr>
      ...
      <div class="container">
<form action="act2x.php" method="post" id="test">
...
<?php
$ran2=$_GET['ran2'];
//COMENZAMOS CON EL ALGORITMO PARA NO REPETIR LA PREGUNTA DEL EXAMEN
$consulta="SELECT * FROM preguntas WHERE id_examen='$id_examen' AND numero='$ran2'";
if ($resultado=$link->query($consulta)) {
         while ($row=$resultado->fetch_assoc()) {
...
echo "<tr>";
echo "<td colspan='2'><strong>PREGUNTA # 2:</strong><font class='lead text-primary'> ".$preg."</font><br><br>";

echo "<input type='hidden' name='id_examen' value='".$id_examen."'>";
echo "<input type='hidden' name='ran2' value='".$ran2."'>";     
