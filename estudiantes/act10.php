...
$datetime2 = new DateTime($final10);
...
<hr>
      <div class="container">
<form action="act10x.php" method="post"  id="test">
...
<?php
$ran10=$_GET['ran10'];
$consulta="SELECT * FROM preguntas WHERE id_examen='$id_examen' AND numero='$ran10'";
if ($resultado=$link->query($consulta)) {
         while ($row=$resultado->fetch_assoc()) {
...
echo "<tr>";
echo "<td colspan='2'><strong>PREGUNTA # 10:</strong><font class='lead text-primary'> ".$preg."</font><br><br>";

echo "<input type='hidden' name='id_examen' value='".$id_examen."'>"; 
echo "<input type='hidden' name='ran10' value='".$ran10."'>";     
