...
<hr>
      ...
      <div class="container">
<form action="act6x.php" method="post" id="test">
...
<?php
$ran6=$_GET['ran6'];
$consulta="SELECT * FROM preguntas WHERE id_examen='$id_examen' AND numero='$ran6'";
if ($resultado=$link->query($consulta)) {
         while ($row=$resultado->fetch_assoc()) {
...
echo "<tr>";
echo "<td colspan='2'><strong>PREGUNTA # 6:</strong><font class='lead text-primary'> ".$preg."</font><br><br>";

echo "<input type='hidden' name='id_examen' value='".$id_examen."'>"; 
echo "<input type='hidden' name='ran6' value='".$ran6."'>";     
